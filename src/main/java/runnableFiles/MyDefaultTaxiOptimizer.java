 ...
 * @author michalm
 */
public class MyDefaultTaxiOptimizer implements TaxiOptimizer {
	...
	public MyDefaultTaxiOptimizer(TaxiConfigGroup taxiCfg, Fleet fleet, TaxiScheduler scheduler,
	...
	public static boolean isNewDecisionEpoch(@SuppressWarnings("rawtypes") MobsimBeforeSimStepEvent e,int epochLength) {
